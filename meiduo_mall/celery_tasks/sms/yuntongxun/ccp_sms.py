...
_accountSid = '8a216da8762cb4570176d2c6be6e3bd8'

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
_accountToken = 'cd2fd9ee3bf8447f8cf1bd99e874313b'

# 请使用管理控制台首页的APPID或自己创建应用的APPID
_appId = '8a216da8762cb4570176d2c6bf433bdf'
...
if __name__ == '__main__':
    # 注意： 测试的短信模板编号为1
    CCP().send_template_sms('18100209298', ['123456', 5], 1)
