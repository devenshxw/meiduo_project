...
SECRET_KEY = 'u-7u1unv^y4z2_2s$hox3ke@p6nlw0n82jejt1ldg0&r+9a02w'
...
EMAIL_PORT = 25 # 发邮件端口
EMAIL_HOST_USER = 'devensh@163.com' # 授权的邮箱
EMAIL_HOST_PASSWORD = 'QTSUDMQFAXQWHAUB' # 邮箱授权时获得的密码，非注册登录密码
EMAIL_FROM = '美多商城<devensh@163.com>' # 发件人抬头
# 邮箱验证链接
EMAIL_VERIFY_URL = 'http://127.0.0.1:8000/emails/verification/'
# 指定自定义的Django文件存储类
DEFAULT_FILE_STORAGE = 'meiduo_mall.utils.fastdfs.fdfs_storage.FastDFSStorage'
# FastDFS相关参数
FDFS_BASE_URL = 'http://192.168.0.112:8888/'

# Haystack
HAYSTACK_CONNECTIONS = {
    'default': {
        'ENGINE': 'haystack.backends.elasticsearch_backend.ElasticsearchSearchEngine',
        'URL': 'http://192.168.0.112:9200/', # Elasticsearch服务器ip地址，端口号固定为9200
